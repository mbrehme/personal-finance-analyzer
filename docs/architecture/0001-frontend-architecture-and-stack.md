...
Für das Projekt _Personal Finance Analyzer_ wird eine schlanke, moderne und typensichere Frontend-Architektur benötigt. Das Projekt soll ohne Monorepo-Komplexität, ohne Backend-Abhängigkeit und mit direktem Entwicklungsfokus aufgerollt werden.
