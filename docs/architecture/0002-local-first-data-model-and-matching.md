...
- **Option A: Reine In-Memory/LocalStorage-Lösung**
  - _Vorteile:_ Sehr einfache Implementierung.
  - _Nachteile:_ LocalStorage ist auf ca. 5 MB begrenzt und blockiert den Hauptthread.
- **Option B: IndexedDB mit typisiertem Local-First State Store (Gewählt)**
  - _Vorteile:_ Nahezu unbegrenzter clientseitiger Speicher, asynchroner Zugriff, vollständige Offline-Verfügbarkeit, portable JSON-Konfigurations-Backups.
  - _Nachteile:_ Asynchrone Schnittstelle erfordert sauberen Service-Layer.
