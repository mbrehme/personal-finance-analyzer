...
describe('transactionDeduplication', () => {
  ...
  describe('findMatchingTransaction', () => {
    ...
    it('matches counterpart transfer via cross-IBAN matching when signs are opposite', () => {
      // Buchung 1: Ausgang auf Girokonto, sender = Giro, receiver = Rücklagen
      const giroTx: Transaction = {
        ...
        receiverIban: 'DE80120300001027106861',
      ...
      // Buchung 2: Eingang auf Rücklagenkonto, cross-IBAN
    ...
    it('does not falsely match opposite signed transactions of same amount with generic subject without partner match', () => {
      const txOutflow: Transaction = {
        ...
        type: 'outbound',
        senderIban: 'DE89120300001083850147',
        receiverIban: 'DE11111111111111111111',
        subject: 'Überweisung',
        sender: 'Martin Brehme',
        receiver: 'Vermieter',
        issuer: '',
      ...
      const txInflow: Transaction = {
        ...
        value: 50,
        type: 'inbound',
        senderIban: 'DE22222222222222222222',
        receiverIban: 'DE80120300001027106861',
        subject: 'Überweisung',
  ...
  describe('mergeTransactions', () => {
    ...
    it('enriches senderIban and receiverIban when merging counterpart transactions from opposite accounts', () => {
      const existingOnRuecklagen: Transaction = {
        id: 'tx-tg-1',
        date: '2026-09-07',
        amount: 250,
        value: 250,
      ...
      const incomingOnHauptkonto: Transaction = {
        id: 'tx-giro-1',
        date: '2026-09-07',
        amount: 250,
        value: -250,
      ...
      const merged = mergeTransactions(existingOnRuecklagen, incomingOnHauptkonto);
      expect(merged.senderIban).toBe('DE89120300001083850147');
      expect(merged.receiverIban).toBe('DE80120300001027106861');
    });
  });
});
